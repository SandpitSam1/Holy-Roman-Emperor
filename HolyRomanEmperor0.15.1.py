...
def evaluate_turn():
    ...
    #evaluate_end_of_turn() #commented out bc it hasn't been defined yet
...
def evaluate_army_orders():
    ...
    for p in army_locations:
        ...
        if owner_army_index == -1:
            ...
            #if there is a tie then there are battles
            else:
                #does battles until there is only one army
...
#TODO
#returns the size of both armies after the battle
def evaluate_battle(province_id, country_1, country_2):
    ...
    if army_1 + army_difference <= 1:
        ...
        new_army_1 -= round(army_1 / (army_1 + army_difference))
