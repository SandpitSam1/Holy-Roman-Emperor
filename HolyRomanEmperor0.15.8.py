    ...
    for province_id, p in enumerate(army_locations):
        ...
        if owner_army_index == -1:
            ...
            if len(p) == 1:
                ...
                province_owners[province_id][owner_territory_index][0] = p[0][0]
                #move to next province
                print(p, province_id, province_owners[province_id])
                continue
            ...
            proince_owners[province_id][owner_territory_index][0] = countries_with_largest_army[0]
            continue #move to next province after resolution
...
def evaluate_battle(province_id, country_1, country_2):
    print("uh oh") #printed for testing in senarios that shouldn't have battles
