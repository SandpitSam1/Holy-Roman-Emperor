...
def evaluate_army_orders():
    ...
    for province_id, p in enumerate(army_locations):
        ...
        if owner_army_index == -1:
            ...
            province_owners[province_id][owner_territory_index][0] = countries_with_largest_army[0]
            continue #move to next province after resolution
...
def calculate_territory_loss(province_id, defender_country_id, attacker_country_id, attacking_armies, defending_armies):
    global province_owners
    ...
    province_owners[province_id][defender_territory_index][1] -= army_difference * 100
    if province_owners[province_id][defender_territory_index][1] <= 0:
        province_owners[province_id].pop(defender_territory_index)
    
    #add a variable to replace old_defender_territory which is territory_gained or something
    #make the attacker gain the territory
    #replace flat gains with this once done.
