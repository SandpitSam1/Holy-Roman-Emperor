...
def display_army_info():
    ...
    if moved_armies > 0:
        ...
        if moved_armies == total_armies:
            print(COUNTRIES[player_country_id] + " have moved all of your armies, and they are stationed in these provinces:")
        else:
            print(COUNTRIES[player_country_id] + " have moved some of your armies, and they are stationed in these provinces:")
